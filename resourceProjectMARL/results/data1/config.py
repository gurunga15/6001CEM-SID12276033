...
CONFIG = {   '_disable_action_flattening': False,
    ...
    'env_config': {   'gridSize': (20, 20),
                      'hybridRewardMix': 0.5,
                      'numAgents': 8,
                      'output_dir': 'results/data1',
                      'renderMode': None,
                      'rewardType': 'hybrid',
                      'seed': 879768,
    ...
    'evaluation_config': {   'env_config': {   'gridSize': (20, 20),
                                               'hybridRewardMix': 0.5,
                                               'numAgents': 8,
                                               'output_dir': 'results/data1',
                                               'renderMode': None,
    ...
    'log_level': 'WARN',
    'log_sys_usage': True,
    'logger_config': {'logdir': 'results/data1\\tensorboard', 'type': 'ray.tune.logger.TBXLogger'},
    'logger_creator': None,
    'lr': 0.0003,
    'lr_schedule': None,
    'map_batches_kwargs': {},
