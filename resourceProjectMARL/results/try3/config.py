...
CONFIG = {   '_disable_action_flattening': False,
    ...
    'env_config': {   'gridSize': (10, 10),
                      'hybridRewardMix': 0.5,
                      'numAgents': 2,
                      'output_dir': 'results/try3',
                      'renderMode': None,
                      'rewardType': 'hybrid',
                      'seed': 530549,
    ...
    'evaluation_config': {   'env_config': {   'gridSize': (10, 10),
                                               'hybridRewardMix': 0.5,
                                               'numAgents': 2,
                                               'output_dir': 'results/try3',
                                               'renderMode': None,
    ...
    'log_level': 'WARN',
    'log_sys_usage': True,
    'logger_config': {'logdir': 'results/try3\\tensorboard', 'type': 'ray.tune.logger.TBXLogger'},
    'logger_creator': None,
    'lr': 0.0003,
    'lr_schedule': None,
    'map_batches_kwargs': {},
