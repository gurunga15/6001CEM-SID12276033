...
4. **Memory Management Challenges**:
   - Episode recording created significant memory usage with many agents or long episodes
   - Issue: Storing complete trajectories for large environments consumed excessive memory
   - Mitigation: Implemented options to disable recording and limit episode length
   - Future work: Need better serialization and streaming approaches for large episodes
...
1. **Algorithm Focus**:
   ...
   - Reason: PPO proved more stable and easier to extend with centralised critics
...
1. **British English Standardisation**:
   - Converted American spellings to British English throughout the codebase
   - Examples: initialise, optimise, visualisation, behaviour, centre, colour
   - Reason: Consistency with project requirements

2. **Variable Naming Conventions**:
   - Refactored snake_case variables to camelCase
   - Updated function and variable names for consistency
   - Examples: use_flattened → useFlattened, agent_id_str → agentIdStr
...
1. **GUI Visualisation**:
   - The PyQt6 GUI remains problematic and unreliable
   - Future work needed to stabilise the visualisation system

2. **Memory Efficiency**:
   - Episode recording still consumes significant memory
   - Need more efficient data structures and serialization
...
1. **Technical Lessons**:
   ...
   - British English spelling and camelCase conventions require systematic refactoring
